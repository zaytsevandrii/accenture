...
export default function Home() {
    return (
        ...
        <video
          ...
          preload="metadata"
        >
        <source src="https://firebasestorage.googleapis.com/v0/b/dimax-f1bfc.appspot.com/o/Maturity-Index-Marquee-Video-1920x1080.mp4?alt=media&token=e0fee0e3-a01f-4213-880a-9789d3824e1f" type="video/mp4" />
        </video>`,
                            }}
                        />
